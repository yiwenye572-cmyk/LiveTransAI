...
<p align="center">
  <img src="docs/images/ui-overview.svg" alt="LiveTransAI 同传主界面示意：左侧摘要与规整译文，右侧实时字幕，底部控制栏" width="720">
</p>
...
**纠错展示**（后台 DeepSeek 校对后，前端可感知修正）：

<p align="center">
  <img src="docs/images/correction-demo.svg" alt="纠错效果：旧译删除线、新译高亮、修正原因" width="640">
</p>
...
<p align="center">
  <img src="frontend/demo-scenarios/images/online-course.webp" alt="内置网课演示场景（配置页）" width="480">
</p>
...
同传页还支持：**专注字幕**（隐藏侧栏放大字幕）、**历史会话**、**暂停 / 恢复 / 停止**、**语音开关**。
